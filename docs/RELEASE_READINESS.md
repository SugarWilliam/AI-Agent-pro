...
| docs/RELEASES.md | 发布说明汇总（含 v8.5.3、v8.5.2、v8.5.1、v8.5.0 等） |
...
git tag -a v8.5.3 -m "Release v8.5.3"
git push origin v8.5.3
git checkout main && git merge gh-pages && git push origin main && git checkout gh-pages
```

### 5.3 发布后

- [ ] 在 GitHub 创建 Release：https://github.com/SugarWilliam/AI-Agent-pro/releases/new?tag=v8.5.3
- [ ] **勾选「Set as a pre-release」**：此版本标注为非生产就绪（non-production ready）
- [ ] 填写 Release 说明（可复制 CHANGELOG 8.5.3 或 docs/RELEASES.md 对应段落）
