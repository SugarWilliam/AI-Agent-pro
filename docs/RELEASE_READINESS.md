...
| docs/RELEASES.md | 发布说明唯一汇总（含 v8.6.4 / v8.6.1 / v8.6.0 等摘要与发布命令；含 v8.5.3…） |
...
git tag -a v8.6.4 -m "Release v8.6.4"
...
- [ ] 在 GitHub 创建 Release：https://github.com/SugarWilliam/AI-Agent-pro/releases/new?tag=v8.6.4
- [ ] **勾选「Set as a pre-release」**：此版本标注为非生产就绪（non-production ready）
- [ ] 填写 Release 说明（可复制 CHANGELOG 8.6.4 或 docs/RELEASES.md 对应段落）
