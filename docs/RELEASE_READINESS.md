...
git tag -a v8.3.1 -m "Release v8.3.1"
...
- [ ] 在 GitHub 创建 Release：https://github.com/SugarWilliam/AI-Agent-pro/releases/new?tag=v8.3.1
- [ ] **勾选「Set as a pre-release」**：此版本标注为非生产就绪（non-production ready）
- [ ] 填写 Release 说明（可复制 CHANGELOG 8.3.1 内容）
